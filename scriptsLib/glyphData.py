...
class GlyphData:
    ...
    def __init__(self, uni=None, unicodes=None, c=None, name=None, comment=None, hex=None,
        wght=REGULAR, ELXP=CLOSED_QUAD, ELSHIndex=0, slnt=ROMAN,
        ):
        ...
        self.ELSH = ELSH2VALUE.get(ELSHIndex) # Shape value for axis value. Use ELSHIndex for shape index value
    ...
    def is_default(self):
        return (self.wght == wght_DEF and
                self.ELXP == ELXP_DEF and
                self.ELSH == ELSH_DEF and
                self.slnt == slnt_DEF)
...
PIXEL_DATA = {
    ...
    DEFAULT_PIXEL_NAME: GD(ELSHIndex=1, wght=REGULAR, ),
    ...
    'Pix01@20': GD(ELSHIndex=1, wght=BLACK,),
    ...
    'Pix02@00': GD(ELSHIndex=2, wght=THIN, ),
    ...
    'Pix02@10': GD(ELSHIndex=2, wght=REGULAR, ),
    ...
    'Pix02@20': GD(ELSHIndex=2, wght=BLACK, ),
    ...
    'Pix03@00': GD(ELSHIndex=3, wght=THIN, ),
    ...
    'Pix03@10': GD(ELSHIndex=3, wght=REGULAR, ),
    ...
    'Pix03@20': GD(ELSHIndex=3, wght=BLACK, ),
    ...
    'Pix04@00': GD(ELSHIndex=4, wght=THIN, ),
    ...
    'Pix04@10': GD(ELSHIndex=4, wght=REGULAR, ),
    ...
    'Pix04@20': GD(ELSHIndex=4, wght=BLACK, ),
    ...
    'Pix05@00': GD(ELSHIndex=5, wght=THIN, ),
    ...
    'Pix05@10': GD(ELSHIndex=5, wght=REGULAR, ),
    ...
    'Pix05@20': GD(ELSHIndex=5, wght=BLACK, ),
    ...
    'Pix06@00': GD(ELSHIndex=6, wght=THIN, ),
    ...
    'Pix06@10': GD(ELSHIndex=6, wght=REGULAR, ),
    ...
    'Pix06@20': GD(ELSHIndex=6, wght=BLACK, ),
    ...
    'Pix07@00': GD(ELSHIndex=7, wght=THIN, ),
    ...
    'Pix07@10': GD(ELSHIndex=7, wght=REGULAR, ),
    ...
    'Pix07@20': GD(ELSHIndex=7, wght=BLACK, ),
    ...
    'Pix08@00': GD(ELSHIndex=8, wght=THIN, ),
    ...
    'Pix08@10': GD(ELSHIndex=8, wght=REGULAR, ),
    ...
    'Pix08@20': GD(ELSHIndex=8, wght=BLACK, ),
    ...
    'Pix09@00': GD(ELSHIndex=9, wght=THIN, ),
    ...
    'Pix09@10': GD(ELSHIndex=9, wght=REGULAR, ),
    ...
    'Pix09@20': GD(ELSHIndex=9, wght=BLACK, ),
    ...
    'Pix10@00': GD(ELSHIndex=10, wght=THIN, ),
    ...
    'Pix10@10': GD(ELSHIndex=10, wght=REGULAR, ),
    ...
    'Pix10@20': GD(ELSHIndex=10, wght=BLACK, ),
    ...
    'Pix11@00': GD(ELSHIndex=11, wght=THIN, ),
    ...
    'Pix11@10': GD(ELSHIndex=11, wght=REGULAR, ),
    ...
    'Pix11@20': GD(ELSHIndex=11, wght=BLACK, ),
    ...
    'Pix12@00': GD(ELSHIndex=12, wght=THIN, ),
    ...
    'Pix12@10': GD(ELSHIndex=12, wght=REGULAR, ),
    ...
    'Pix12@20': GD(ELSHIndex=12, wght=BLACK, ),
