...
* 🔥 **FAIL** <p>Current FontBakery version is 0.12.10, while a newer 1.0.1 is already available. Please upgrade it with 'pip install -U fontbakery'</p>
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: tifinagh, canadian-aboriginal, coptic, malayalam, math, syriac, old-permic, tai-le</li>
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Ukrainian (Cyrl, 29,273,587 speakers), Navajo (Latn, 166,319 speakers), Igbo (Latn, 27,823,640 speakers), Belarusian (Cyrl, 10,064,517 speakers), Aghem (Latn, 38,843 speakers), Basaa (Latn, 332,940 speakers).</p>
 [code: soft-dotted]
