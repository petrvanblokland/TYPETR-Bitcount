...
function updateTextStyle() {
    ...
    const fontVariationSettings = `'wght' ${weight}, 'ELXP' ${elementOpen}, 'ELSH' ${elementShape}, 'slnt' ${slant},
    'SZP1' ${bgSize}, 'XPN1' ${bgX}, 'YPN1' ${bgY}, 
    'SZP2' ${fgSize}, 'XPN2' ${fgX}, 'YPN2' ${fgY}`;

    sampleText1.style.fontSize = `${size}px`;
    sampleText1.style.fontVariationSettings = fontVariationSettings;
    sampleText2.style.fontSize = `${size}px`;
    sampleText2.style.fontVariationSettings = fontVariationSettings;
}
